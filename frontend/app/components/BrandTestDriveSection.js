// app/components/BrandTestDriveSection.js
"use client";
...
const brands = [
  ...
  },
  {
    id: "kgm",
    name: "KGM",
    logo: "https://carbar.co.kr/static/images/brand/kgm.png", // 필요하면 수정
    url: "https://www.kg-mobility.com/od/network/bridge",
  },
  {
    id: "chevrolet",
...
const AUTO_SCROLL_INTERVAL = 2000; // ⏱ 자동 이동 주기 (더 빠르게)
const AUTO_SCROLL_STEP = 280; // 한 번에 이동 거리
...
export default function BrandTestDriveSection() {
  ...
  return (
    <section className="brand-testdrive-section">
      <h2 className="brand-testdrive-title">
        제조사별 차량 시승 신청해보세요
      </h2>
      ...
      >
        ...
        <div
          ref={scrollRef}
          className="brand-testdrive-scroll"
